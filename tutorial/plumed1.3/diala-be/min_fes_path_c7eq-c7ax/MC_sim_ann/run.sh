...
python3.8 ../../../../../graf_fes_kmc.py -noforces -nofes -readfes -rfesfile ../../results/fes.out -mfepath -rneighs -nopneighs -ineighf neighs.out -sbmfepath 2618 -fbmfepath 11109 -temp 400 -npaths 1000 -pathtemp 1 -units kj -itpfile per_iter_path_c7eq_c7ax_2_50.out -pfile path_c7eq_c7ax_2_50.out -mctemp 50


for((i=50;i>10;i-=10)); do python3.8 ../../../../../graf_fes_kmc.py -noforces -nofes -readfes -rfesfile ../../results/fes.out -mfepath -rneighs -nopneighs -ineighf neighs.out -sbmfepath 2618 -fbmfepath 11109  -temp 400 -npaths 100000 -pathtemp 1 -units kj -itpfile per_iter_path_c7eq_c7ax_2_$((i-10)).out -pfile path_c7eq_c7ax_2_$((i-10)).out -tpaths 1 -mctemp $((i-10)) -readpath -rpathfile path_c7eq_c7ax_2_${i}.out ; done

for((i=10;i>1;i-=1)); do python3.8 ../../../../../graf_fes_kmc.py -noforces -nofes -readfes -rfesfile ../../results/fes.out -mfepath -rneighs -nopneighs -ineighf neighs.out -sbmfepath 2618 -fbmfepath 11109  -temp 400 -npaths 100000 -pathtemp 1 -units kj -itpfile per_iter_path_c7eq_c7ax_2_$((i-1)).out -pfile path_c7eq_c7ax_2_$((i-1)).out -tpaths 1 -mctemp $((i-1)) -readpath -rpathfile path_c7eq_c7ax_2_${i}.out ; done

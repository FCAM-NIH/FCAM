...
python3.8 ../../../../graf_fes_kmc.py -nofes -ff ../results/grad_on_eff_points.out -smfepath -sbmfepath 2618 -fbmfepath 11109 -temp 298 -units kj -pathtemp 1 -itpfile per_iter_path_c7eq-c7ax_ff.out -pfile path_c7eq-c7ax_ff.out
